...
execute as @s at @s run summon armor_stand ~ ~1 ~ {NoGravity:1b,Invulnerable:1b,Small:1b,Marker:1b,Invisible:1b,Tags:["MagicSpell","LaserSpell","Tagged"],DisabledSlots:4144959,Silent:1b}
