...
summon armor_stand ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Small:1b,Marker:1b,DisabledSlots:4144959,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["RandomzMain"]}
...
tellraw joshtiger [{"text":"RN: "},{"score":{"name":"@e[tag=RandomzMain]","objective":"RN"}}]
scoreboard players operation @e[tag=RandomzMain] Result += @e[tag=RandomzMain] RN