...
scoreboard players set @e[limit=1,sort=nearest,tag=Turret,distance=0..1] TurretCheck 5
scoreboard players set @e[limit=1,sort=nearest,tag=Turret,distance=0..1] TurretCheckMax 12
scoreboard players set @e[limit=1,sort=nearest,tag=Turret,distance=0..1] TargetedID 0
scoreboard players set @e[limit=1,sort=nearest,tag=Turret,distance=0..1] Targeting 0
