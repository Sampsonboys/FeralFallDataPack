...
execute as @s[type=armor_stand] at @s if entity @s[tag=END] run kill @e[distance=0..12,tag=EnemyScanner]
execute as @s[type=armor_stand] at @s if entity @s[tag=END] run kill @e[distance=0..12,tag=EnemyTracker]
