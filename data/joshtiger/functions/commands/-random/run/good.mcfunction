...
#                                                             #
###############################################################
execute as @a[tag=RandomExecute] if entity @s[tag=JTDebug] run tellraw @s {"text":"§9[§2§lJ§6§lT§9]: §eExecuteing §aGood"}
...
execute if entity @e[tag=RandomzMain,scores={RN=1..1}] at @s as @a[tag=RandomExecute] at @s run function joshtiger:commands/-random/good/clearbadomen
execute if entity @e[tag=RandomzMain,scores={RN=2..2}] at @s as @a[tag=RandomExecute] at @s run function joshtiger:commands/-random/good/haste2
execute if entity @e[tag=RandomzMain,scores={RN=3..3}] at @s as @a[tag=RandomExecute] at @s run function joshtiger:commands/-random/good/haste3
execute if entity @e[tag=RandomzMain,scores={RN=4..4}] at @s as @a[tag=RandomExecute] at @s run function joshtiger:commands/-random/good/invisible
execute if entity @e[tag=RandomzMain,scores={RN=5..5}] at @s as @a[tag=RandomExecute] at @s run function joshtiger:commands/-random/good/john
execute if entity @e[tag=RandomzMain,scores={RN=6..6}] at @s as @a[tag=RandomExecute] at @s run function joshtiger:commands/-random/good/lowgravity
execute if entity @e[tag=RandomzMain,scores={RN=7..7}] at @s as @a[tag=RandomExecute] at @s run function joshtiger:commands/-random/good/luck
execute if entity @e[tag=RandomzMain,scores={RN=8..8}] at @s as @a[tag=RandomExecute] at @s run function joshtiger:commands/-random/good/lumberjack
execute if entity @e[tag=RandomzMain,scores={RN=9..9}] at @s as @a[tag=RandomExecute] at @s run function joshtiger:commands/-random/good/mrcolorful
execute if entity @e[tag=RandomzMain,scores={RN=10..10}] at @s as @a[tag=RandomExecute] at @s run function joshtiger:commands/-random/good/nighteye
execute if entity @e[tag=RandomzMain,scores={RN=11..11}] at @s as @a[tag=RandomExecute] at @s run function joshtiger:commands/-random/good/regeneration
execute if entity @e[tag=RandomzMain,scores={RN=12..12}] at @s as @a[tag=RandomExecute] at @s run function joshtiger:commands/-random/good/speed
execute if entity @e[tag=RandomzMain,scores={RN=13..13}] at @s as @a[tag=RandomExecute] at @s run function joshtiger:commands/-random/good/speed2
